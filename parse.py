...
location_names = load_location_names(
    os.path.join("data", "plugins", "astrbot_plugin_foxholebot","data", "Location_names.json")
)
...
targets = load_json_to_dict(os.path.join("data", "plugins", "astrbot_plugin_foxholebot","data", "Targets.json"))
damages = load_json_to_dict(os.path.join("data", "plugins", "astrbot_plugin_foxholebot","data", "Damage.json"))
weapons = load_json_to_dict(os.path.join("data", "plugins", "astrbot_plugin_foxholebot","data", "Weapons.json"))
all = weapons | targets
bunker_stats = load_json_to_dict(os.path.join("data", "plugins", "astrbot_plugin_foxholebot","data", "Bunker_piece.json"))
